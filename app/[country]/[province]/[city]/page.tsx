...
import {
  generateCityOverviewParagraph,
  generateWeatherCityParagraph,
  generatePrayerTimingsParagraph,
  generateGoldRatesParagraph,
  generateEconomyParagraph,
  generateLocationParagraph,
  generateCultureHeritageParagraph,
  generateSportsAndLeisureParagraph,
} from '@/lib/paragraphs/cityParagraphs';
import {
  generateNewsIntroductionParagraph,
  generateLocalNewsCategories,
  generateMediaOutletsParagraph,
} from '@/lib/paragraphs/newsParagraphs';
import { generateCityMeta, generateCitySchema, generateBreadcrumbSchema, generateFAQSchema } from '@/lib/seo/schemaMarkup';
...
export default function CityPage() {
  ...
  useEffect(() => {
    ...
    breadcrumbScript.textContent = JSON.stringify(generateBreadcrumbSchema(city));
    document.head.appendChild(breadcrumbScript);

    // Create and inject city schema
    const cityScript = document.createElement('script');
    cityScript.type = 'application/ld+json';
    cityScript.id = 'city-schema';
    cityScript.textContent = JSON.stringify(generateCitySchema(city));
    ...
    faqScript.textContent = JSON.stringify(generateFAQSchema(city, { temp: '34', humidity: '52', population: city.population }));
    document.head.appendChild(faqScript);

    // Update meta tags
    document.title = `${city.name} — Weather, Prayer Times, Gold Rate & News | ${city.province}`;
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', `Live ${city.name} information: weather, prayer times, gold rates, news, and complete city guide.`);
    }
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="mt-16 border-t border-white/10 pt-12">
            <div className="space-y-12">
              ...
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h2 className="text-3xl font-bold text-white mb-6">{city.name}: A Complete City Guide</h2>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateCityOverviewParagraph(city),
                  }}
                />
              </motion.div>
              ...
              {/* Weather Information */}
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Climate and Weather in {city.name}</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateWeatherCityParagraph(city, {}),
                  }}
                />
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Prayer Times and Islamic Heritage</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generatePrayerTimingsParagraph(city, {}),
                  }}
                />
              </motion.div>
              ...
              {/* Gold Rates */}
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Gold, Silver, and Precious Metals</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateGoldRatesParagraph(city, {}),
                  }}
                />
              </motion.div>
              ...
              {/* Economy */}
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Economy and Business</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateEconomyParagraph(city),
                  }}
                />
              </motion.div>
              ...
              {/* Location */}
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Location and Geography</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateLocationParagraph(city),
                  }}
                />
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Cultural Heritage and Landmarks</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateCultureHeritageParagraph(city),
                  }}
                />
              </motion.div>
              ...
              {/* Sports */}
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">Sports and Recreation</h3>
                <div
                  dangerouslySetInnerHTML={{
                    __html: generateSportsAndLeisureParagraph(city),
                  }}
                />
              </motion.div>
              ...
              {/* News */}
              <motion.div variants={itemVariants} className="prose prose-invert max-w-none">
                <h3 className="text-2xl font-bold text-white mb-4">News and Current Events</h3>
                <div
                  dangerouslySetInnerHTML={{
